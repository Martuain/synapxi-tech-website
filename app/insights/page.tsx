...
const categoriesEn = ['All', 'AI', 'Web3', 'Payments', 'Product Strategy', 'Digital Transformation']
const categoriesEs = ['Todos', 'IA', 'Web3', 'Pagos', 'Estrategia de Producto', 'Transformación Digital']
