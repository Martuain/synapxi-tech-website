...
const articlesEn = [
  ...
  { id: 'web3-substack',                   tag: 'Web3',                  source: 'substack',  title: 'Cinema in the Age of Web3: Why DAOs Could Rewrite Hollywood’s Rules',     excerpt: 'Published on Substack. For over a century, Hollywood has been the center of worldwide storytelling, shaping not just how movies are made but also how they are funded, distributed, and consumed. Yet, beneath the glitz of red carpets and billion-dollar franchises lies a fragile economic system—one that explains why the industry feels more centralized, risk-averse, and uncreative than ever.',    readTime: '8', href: 'https://martinfmora.substack.com/p/web3-and-the-future-of-collective' },
  // ── Published on Medium ──
  ...
  // ── ISO 20022 ──
  { id: 'iso20022-payments',               tag: 'Payments',              source: 'substack',  title: 'ISO 20022 and the Data-Rich Future of Payments',                          excerpt: 'The migration to ISO 20022 is more than a technical upgrade — it is an opportunity to unlock rich payment data that enables entirely new product and risk management capabilities.',                       readTime: '5', href: 'https://martinfmora.substack.com/p/iso-20022-and-the-data-rich-future' },
]
...
const articlesEs = [
  ...
  { id: 'web3-substack',                   tag: 'Web3',                  source: 'substack',  title: 'El cine en la era de la Web3: Por qué las DAO podrían reescribir las reglas de Hollywood',                              excerpt: 'Publicado en Substack. Durante más de un siglo, Hollywood ha sido el centro de la narrativa mundial, moldeando no solo la forma en que se hacen las películas, sino también cómo se financian, distribuyen y consumen. Sin embargo, bajo el glamour de las alfombras rojas y las franquicias multimillonarias se esconde un sistema económico frágil, uno que explica por qué la industria se siente más centralizada, reacia al riesgo y menos creativa que nunca.',                 readTime: '8', href: 'https://martinfmora.substack.com/p/web3-and-the-future-of-collective' },
